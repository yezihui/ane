...
<html>
	...
	<script src="../js/arbitration/arbdeclare.js"></script>
	<!--[if lt IE 9]>
		<script>
			$(function(){
	...
	<body>
		<div class="btn-div">
			...
			<input type="button" class="add-btn cs" value="新增"/>
			<input type="button" class="gbtn update-btn" value="修改" disabled="disabled"/>
			<input type="button" class="gbtn del-btn" value="删除" disabled="disabled"/>
			<input type="button" class="gbtn sub-btn" value="保存" disabled="disabled"/>
		</div>
		<ul class="type-tab">
