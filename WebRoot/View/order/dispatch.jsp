...
.info {
	...
	<body>
		<div class="btn-div">
			<input type="button" class="dispatch-btn" value="派送"/>
		</div>
			...
			<form class="condition-form">
				<div class="condition">
					<div class="condition-title">
						<img class="t-img" src="../img/shezhi.png" /> <span>派送信息</span>
						<img class="o-img" src="../img/arrowtop.png" />
					</div>
					<div class="condition-div">
						<div class="condition-right">
							<div class="input-div">
								<label>输入该运单号</label> <input type="text" name="ewbNo" id="ewbNo" class="dis"/> 
							</div>
						</div>
					</div>
				</div>
				<div class="data">
					<div class="data-width">
						<table class="data-title">
							<tr>
								<th style="padding-right:16px;">派送信息(请双击信息确认派送)</th>
							</tr>
						</table>
