...
.info {
	...
	<body>
		<div class="btn-div">
			<input type="button" class="follow-btn" value="查询"/>
		</div>
				...
				<div class="condition">
					...
					<div class="condition-div">
						<div class="condition-right">
							<div class="input-div">
								<label>输入该运单号</label> <input type="text" name="ewbNo" id="ewbNo" class="fol"/> 
							</div>
						</div>
					</div>
				</div>
				<div class="data">
					<div class="data-width">
						<table class="data-title">
							<tr>
								<th>扫描时间</th>
								<th colspan="7" style="padding-right:16px;">运单详情</th>
							</tr>
						</table>
