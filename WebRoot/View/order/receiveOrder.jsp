...
<html>
	...
	<script src="../js/order/rsOrder.js"></script>
...
.info {
	...
	<body>
		<div class="btn-div">
			<input type="button" class="sub-btn" value="到件"/>
		</div>
			...
			<form class="condition-form">
				<div class="condition">
					<div class="condition-title">
						<img class="t-img" src="../img/shezhi.png" /> <span>到件信息</span>
					...
					<div class="condition-div">
						<div class="condition-right">
							...
							<div class="input-div">
								<label>输入上一网点</label> <input type="text" name="siteName" id="siteName"/> 
							</div>
						</div>
					</div>
				</div>
				<div class="data">
					<div class="data-width">
						<table class="data-title">
							<tr>
								<th style="padding-right:16px;">到件信息(请双击信息上传)</th>
							</tr>
						</table>
