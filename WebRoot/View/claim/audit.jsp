...
<html>
	...
	<script src="../js/claim/audit.js"></script>
	<!--[if lt IE 9]>
		<script>
			$(function(){
	...
	<body>
		<div class="btn-div">
			...
			<input type="button" class="audit-btn gbtn" value="审核通过"/>
			<input type="button" class="noaudit-btn gbtn" value="审核不通过" />
		</div>
		<ul class="type-tab">
						...
						<div class="condition-div">
							...
							<div class="condition-right">
								...
								<label>申报状态</label> <select name="applyState">
									<option value="2">处理完成，待审核</option>
								</select>
							</div>
								<div class="input-div">
									<label>申报网点</label>
			...
			<div class="info windiv">
				<form class="info-form">
					<div>
						...
						<div class="input-div">
						<label>索赔金额</label> <input type="text" name="camount" id="amount" />
					</div>
					<div class="input-div">
					...
					<div class="input-div">
						<label>是否投保</label> <input type="text" name="safe"
							id="safe" />
					</div>
					</div>
				</form>
