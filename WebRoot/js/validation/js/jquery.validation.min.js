...
e.data("jqv"):g.validation.defaults;if((b=f._validateField(a,c))&&c.onFieldSuccess)c.onFieldSuccess();else if(c.onFieldFailure&&0<c.InvalidFields.length)c.onFieldFailure()}return c.onValidationComplete?!!c.onValidationComplete(e,b):b},updatePromptsPosition:function(a){if(a&&this==window)var b=a.data.formElem,c=a.data.noAnimation;else b=g(this.closest("form, .validationEngineContainer"));var e=b.data("jqv");b.find("["+e.validateAttribute+"*=validate]").not(":disabled").each(function(){var a=g(this);
e.prettySelect&&a.is(":hidden")&&(a=b.find("#"+e.usePrefix+a.attr("id")+e.useSuffix));var h=f._getPrompt(a),l=g(h).find(".formErrorContent").html();h&&f._updatePrompt(a,g(h),l,void 0,!1,e,c)});return this},showPrompt:function(a,b,c,e){var d=this.closest("form, .validationEngineContainer").data("jqv");d||(d=f._saveOptions(this,d));c&&(d.promptPosition=c);d.showArrow=!0==e;f._showPrompt(this,a,b,!1,d);return this},hide:function(){var a=g(this).closest("form, .validationEngineContainer").data("jqv"),
...
l=b.promptPosition;"string"==typeof l&&-1!=l.indexOf(":")&&(l=l.substring(0,l.indexOf(":")));if("bottomRight"!=l&&"bottomLeft"!=l&&(l=f._getPrompt(e)))d=l.offset().top;b.scrollOffset&&(d-=b.scrollOffset);if(b.isOverflown){l=g(b.overflownDIV);if(!l.length)return!1;h=l.scrollTop();l=-parseInt(l.offset().top);d+=h+l-5;g(b.overflownDIV+":not(:animated)").animate({scrollTop:d},1100,function(){b.focusFirstField&&e.focus()})}else g("html, body").animate({scrollTop:d},1100,function(){b.focusFirstField&&e.focus()}),
...
_ajax:function(a,b,c,e){var d=e.allrules[b[c+1]];c=d.extraData;var h=d.extraDataDynamic;b={fieldId:a.attr("id"),fieldValue:a.val()};if("object"===typeof c)g.extend(b,c);else if("string"===typeof c){var l=c.split("&");for(c=0;c<l.length;c++){var p=l[c].split("=");p[0]&&p[0]&&(b[p[0]]=p[1])}}if(h){h=String(h).split(",");for(c=0;c<h.length;c++)l=h[c],g(l).length&&(p=a.closest("form, .validationEngineContainer").find(l).val(),l.replace("#",""),escape(p),b[l.replace("#","")]=p)}"field"==e.eventTrigger&&
delete e.ajaxValidCache[a.attr("id")];if(!e.isError&&!f._checkAjaxFieldStatus(a.attr("id"),e))return g.ajax({type:e.ajaxFormValidationMethod,url:d.url,cache:!1,dataType:"json",data:b,field:a,rule:d,methods:f,options:e,beforeSend:function(){},error:function(a,b){if(e.onFailure)e.onFailure(a,b);else f._ajaxError(a,b)},success:function(b){var c=b[0],h=g("#"+c).eq(0);if(1==h.length){var l=b[2];b[1]?(e.ajaxValidCache[c]=!0,l?e.allrules[l]&&(b=e.allrules[l].alertTextOk)&&(l=b):l=d.alertTextOk,e.showPrompts&&
(l?f._showPrompt(h,l,"pass",!0,e):f._closePrompt(h)),"submit"==e.eventTrigger&&a.closest("form").submit()):(e.ajaxValidCache[c]=!1,e.isError=!0,l?e.allrules[l]&&(b=e.allrules[l].alertText)&&(l=b):l=d.alertText,e.showPrompts&&f._showPrompt(h,l,"",!0,e))}h.trigger("jqv.field.result",[h,e.isError,l])}}),d.alertTextLoad},_ajaxError:function(a,b){0==a.status&&null==b?alert("The page is not served from a server! ajax call failed"):"undefined"!=typeof console&&console.log("Ajax error: "+a.status+" "+b)},
...
r=a.position().top;a.height();f=b.height();e=d=0;f=-f;c=a.data("promptPosition")||c.promptPosition;var m="",k="",q=k=0;"string"==typeof c&&-1!=c.indexOf(":")&&(m=c.substring(c.indexOf(":")+1),c=c.substring(0,c.indexOf(":")),-1!=m.indexOf(",")&&(k=m.substring(m.indexOf(",")+1),m=m.substring(0,m.indexOf(",")),q=parseInt(k),isNaN(q)&&(q=0)),k=parseInt(m),isNaN(m));switch(c){default:case "topRight":d+=p+g-30;e+=r;break;case "topLeft":e+=r;d+=p;break;case "centerRight":e=r;f=0;d=p+a.outerWidth(!0)+5;break;
case "centerLeft":d=p-b.outerWidth();e=r;f=0;break;case "bottomLeft":e=r+a.outerHeight();f=0;d=p;break;case "bottomRight":d=p+g-30;e=r+a.outerHeight();f=0;break;case "inline":f=e=d=0}return{callerTopPosition:e+q+"px",callerleftPosition:d+k+"px",marginTopSize:f+"px"}},_saveOptions:function(a,b){if(g.validationEngineLanguage)var c=g.validationEngineLanguage.allRules;else g.error("jQuery.validation rules are not loaded, plz add localization files to the page");g.validation.defaults.allrules=c;c=g.extend(!0,
{},g.validation.defaults,b);a.data("jqv",c);return c},_getClassName:function(a){if(a)return a.replace(/:/g,"_").replace(/\./g,"_")},_jqSelector:function(a){return a.replace(/([;&,\.\+\*\~':"\!\^#$%@\[\]\(\)=>\|])/g,"\\$1")},_condRequired:function(a,b,c,e){var d;for(c+=1;c<b.length;c++)if(d=jQuery("#"+b[c]).first(),d.length&&void 0==f._required(d,["required"],0,e,!0))return f._required(a,["required"],0,e)},_submitButtonClick:function(a){a=g(this);a.closest("form, .validationEngineContainer").data("jqv_submitButton",
a.attr("id"))}};g.fn.validation=function(a){var b=g(this);if(!b[0])return b;if("string"==typeof a&&"_"!=a.charAt(0)&&f[a])return"showPrompt"!=a&&("hide"!=a&&"hideAll"!=a)&&f.init.apply(b),f[a].apply(b,Array.prototype.slice.call(arguments,1));if("object"==typeof a||!a)return f.init.apply(b,arguments),f.attach.apply(b);g.error("Method "+a+" does not exist in jQuery.validation")};g.validation={fieldIdCounter:0,defaults:{validationEventTrigger:"blur",scroll:!0,focusFirstField:!0,showPrompts:!0,validateNonVisibleFields:!1,
promptPosition:"topRight",bindMethod:"bind",inlineAjax:!1,ajaxFormValidation:!1,ajaxFormValidationURL:!1,ajaxFormValidationMethod:"get",onAjaxFormComplete:g.noop,onBeforeAjaxFormValidation:g.noop,onValidationComplete:!1,doNotShowAllErrosOnSubmit:!1,custom_error_messages:{},binded:!0,showArrow:!0,isError:!1,maxErrorsPerField:!1,ajaxValidCache:{},autoPositionUpdate:!1,InvalidFields:[],onFieldSuccess:!1,onFieldFailure:!1,onSuccess:!1,onFailure:!1,validateAttribute:"rule",addSuccessCssClassToField:"",
addFailureCssClassToField:"",autoHidePrompt:!1,autoHideDelay:1E4,fadeDuration:0.3,prettySelect:!1,addPromptClass:"",usePrefix:"",useSuffix:"",showOneMessage:!1}};g(function(){g.validation.defaults.promptPosition=f.isRTL()?"topLeft":"topRight"})})(jQuery);
